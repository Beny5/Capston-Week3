...
unsigned long myChannelNumber = 728346;                // Thingspeak channel ID here
const char * myWriteAPIKey = "7D39L8T12MVZZHYN";       // Write API key here
const char* ssid     = "AndroidHotspot5980";           // SSID of wireless network
const char* password = "sgcs1568";                     // Password for wireless network
String host_aws = "52.15.118.120";               //  AWS
